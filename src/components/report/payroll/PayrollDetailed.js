...
const PayrollDetailed = () => {
  ...
  // Function to generate footer content dynamically
  const getFooterData = (table) => {
    // Here you can implement logic to compute and return dynamic footer data
    return [
  ...
  return (
    <div className="warehouse_purchase_report_table">
      ...
      <div className="tabulator-container" style={{ width: '100%', overflowX: 'auto', height: "auto", marginTop: '20px', borderRadius: "5px",border:"none" }}>
        <ReactTabulator
          columns={columns}
          data={[
...
export default PayrollDetailed;
