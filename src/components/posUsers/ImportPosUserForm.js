            ...
            <Form>
                ...
                <Modal.Body>
                    <div className='row'>
                        ...
                        <div className="col-sm-12 col-md-6 mb-1">
                            <a href='/import_demo_files/import_users.csv' className='btn btn-info me-2 fw-semibold w-100 h-100' type='submit'>
...
export default connect( null, { fetchBrand, editBrand, fetchBrands } )( ImportPosUserform );
